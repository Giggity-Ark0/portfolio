...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Shanit Saha Arko — Computer Science student passionate about programming, AI, and building practical solutions.",
};
          ...
          <div className="space-y-14">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Currently, I’m focused on developing projects that blend software, hardware, and design. Recent work includes the Student Result Management System (SRMS) project, a website for a math presentation, my personal website, and a Smart Environment Guardian System built with Arduino. I experiment with AI models, explore quantum computing theories, and create visual content to explain technical concepts.
              </p>
            </div>
